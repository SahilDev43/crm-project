...
interface SalaryStructureEditProps {
    structureId: number
    onClose: () => void
    onSuccess: () => void
}
...
function SalaryStructureEdit({
    ...
    useEffect(() => {
        const loadStructure = async () => {
            try {
                ...
                const data = await getSalaryStructure(structureId)
    ...
    const handleSubmit = async (
        ...
        try {
            ...
            await updateSalaryStructure(structureId, {
                name: name.trim(),
                code: code.trim(),
                ...
                <div className="flex items-center justify-between border-b border-slate-200 px-6 py-4">
                    ...
                    <div>
                        ...
                        <p className="mt-1 text-xs text-slate-500">
                            Update salary structure information.
                        </p>
                    </div>
