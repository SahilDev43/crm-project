...
import { deleteSalaryStructure } from '../../api/salaryStructures'
import { getApiErrorMessage } from '../../api/errors'

interface SalaryStructureDeleteProps {
    structureId: number
...
function SalaryStructureDelete({
    structureId,
    structureName,
    onClose,
    onSuccess,
}: SalaryStructureDeleteProps) {
...
export default SalaryStructureDelete
